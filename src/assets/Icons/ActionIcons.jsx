...
export const IconAddDoc = ({ className }) => (
  ...
  >
    <path
      fill="#fff"
      d="M9.23 7.23h5.73a1 1 0 0 1 0 2H9.23v5.73a1 1 0 0 1-2 0V9.23H6.001v-2h1.23V6.21h2v1.02Zm-4.155 2H1.5a1 1 0 0 1 0-2h3.575v2ZM8.23.5a1 1 0 0 1 1 1v3.365h-2V1.5a1 1 0 0 1 1-1Z"
    />
    <path
      fill="#212227"
      fillOpacity={0.8}
...
<svg
  ...
  >
    ...
    <path
      ...
      strokeOpacity={0.8}
      strokeWidth={0.25}
      d="m1.95 6.718 16.127.092h.001a2.233 2.233 0 0 1 1.44.524c.384.334.605.789.607 1.268v4.176c0 .238-.055.473-.16.692a1.797 1.797 0 0 1-.45.581c-.192.165-.42.296-.668.385a2.336 2.336 0 0 1-.784.134H1.937a2.23 2.23 0 0 1-1.45-.519c-.389-.334-.611-.792-.611-1.273V8.51c0-.482.222-.94.61-1.273a2.23 2.23 0 0 1 1.45-.519h.014Zm-.014.806c-.315 0-.614.107-.832.295a.915.915 0 0 0-.333.691v4.268c0 .255.117.504.333.691.218.188.517.295.832.295h16.128c.314 0 .613-.107.83-.295a.916.916 0 0 0 .336-.691V8.603l-.006-.096a.933.933 0 0 0-.328-.593 1.283 1.283 0 0 0-.826-.298v-.001L1.942 7.524h-.006Z"
    />
    <path
      fill="#212227"
      fillOpacity={0.8}
